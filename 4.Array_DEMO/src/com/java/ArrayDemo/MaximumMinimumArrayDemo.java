...
public class MaximumMinimumArrayDemo {
	...
	public static void largestAndSmallest(int[] numbers) {
		int largest = Integer.MIN_VALUE;  // largest is initialised with Integer.MIN_VALUE
		int smallest = Integer.MAX_VALUE; // // smallest is initialised with Integer.MAX_VALUE
